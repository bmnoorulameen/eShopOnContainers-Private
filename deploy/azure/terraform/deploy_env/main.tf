...
terraform {
    backend "azurerm" {
        resource_group_name  = "tf_state_storage_Tank" #Your tf state resource group name
        storage_account_name = "tfstatestorageaccteus100" #Your unique tf state storage account name
